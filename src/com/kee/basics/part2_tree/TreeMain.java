...
public class TreeMain {
     ...
     * 3   4   6
     */
    private static TreeNode mRootTreeNode;

    static {
        mRootTreeNode = new TreeNode(1);
        TreeNode secondLeft = new TreeNode(2);
        TreeNode secondRight = new TreeNode(5);
        TreeNode thirdleft = new TreeNode(3);
        TreeNode thirdmidle = new TreeNode(4);
        TreeNode thirdright = new TreeNode(6);
        mRootTreeNode.left = secondLeft;
        mRootTreeNode.right = secondRight;
        secondLeft.left = thirdleft;
        secondLeft.right = thirdmidle;
